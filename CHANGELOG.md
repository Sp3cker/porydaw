...
- Toggling View → Use System Font no longer restyles the whole window through the theme engine, which was unsafe on Windows while playback was painting. The font swap now lands directly and is safe mid-playback.
