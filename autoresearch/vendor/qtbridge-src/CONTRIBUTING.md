...
This project is in **early development**, and we are actively
looking for contributors. Even if you're just getting started with QML,
Qt Quick, or Swift, you're very welcome to contribute — small contributions
...
```shell
  ****    Welcome to Gerrit Code Review    ****
  ...
  git clone ssh://<username>@codereview.qt-project.org:29418/qt/qtbridge-swift.git
...
```shell
git clone "ssh://<username>@codereview.qt-project.org:29418/qt/qtbridge-swift" && (cd "qtbridge-swift" && mkdir -p `git rev-parse \
...
### Prerequisites
You can build the **Qt Bridge for Swift** using either **Swift Package Manager**
or **CMake**.

Make sure you have one of the following installed:

- Xcode with Swift toolchain
- [Latest Swift toolchain](https://www.swift.org/install/macos/)

 And if you decide to build with CMake:
- CMake 3.22 or later
- Ninja
- Qt 6.10 or later

For more details see
[Qt Bridge for Swift](https://doc-snapshots.qt.io/qtbridges-dev/qtbridges-swift-index.html)
documentation page.
...
[Qt Bridges forum](https://forum.qt.io/category/78/qt-bridges) or join our
[Qt Bridges Discord](https://discord.com/invite/WNdGHnHagP) server - we're happy
