...
Rectangle {
    ...
    required property PaginatedResourceColors colors
    required property PaginatedResourceUsers colorViewUsers
                    ...
                    Item {
                        ...
                        Image {
                            ...
                            function getCurrentUserImage() {
                                ...
                                return root.colorViewUsers.avatar(root.loginService.userId)
                            }
                        }
                ...
                RowLayout {
                    ...
                    Repeater {
                        ...
                        ToolButton {
                            ...
                            onClicked: root.colors.setPage(page)
                        }
                    }
                }
            }
