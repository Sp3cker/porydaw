...
struct SmfEvent {
    ...
    NoteId noteId;   // transient document identity (SongDocument mints it for
                     // note-ons); never parsed from or serialized to MIDI
                     // bytes, and excluded from operator== below
