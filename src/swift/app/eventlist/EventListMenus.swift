...
enum EventListAppearance {
    static func roles(palette: GridPalette = GridPalette()) -> [String: QVariantSettable] {
        ["tableBackground": palette.rollBackground,
         "tableAlternateBackground": palette.windowBackground,
         ...
         "headerOutline": palette.separator,
         ...
         "scrollbarHandle": palette.outline,
         "scrollbarHandleHover": palette.focusOutline,
         "toolTipBackground": palette.menuBackground,
         "toolTipText": palette.windowText,
         "toolTipOutline": palette.outline,
         "inputBackground": palette.windowBackground,
