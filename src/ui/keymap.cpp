...
const QList<Def> &catalogue()
{
    static const QList<Def> defs = {
        ...
        sequenceDef("roll.cut", Scope::EditorRouted, QT_TR_NOOP("Cut Selection"),
                    QKeySequence::Cut),
        sequenceDef("roll.duplicate_time", Scope::EditorRouted, QT_TR_NOOP("Duplicate"),
                    QKeySequence::UnknownKey, "Ctrl+D"),
        sequenceDef("roll.split", Scope::EditorRouted, QT_TR_NOOP("Split Notes"),
                    QKeySequence::UnknownKey, "Ctrl+E"),
        sequenceDef("roll.join", Scope::EditorRouted, QT_TR_NOOP("Join Notes"),
                    QKeySequence::UnknownKey, "Ctrl+J"),
        ...
        sequenceDef("roll.lengthen_note", Scope::EditorRouted, QT_TR_NOOP("Lengthen Note"),
                    QKeySequence::UnknownKey, "Shift+Right"),
        sequenceDef("roll.shorten_note", Scope::EditorRouted, QT_TR_NOOP("Shorten Note"),
                    QKeySequence::UnknownKey, "Shift+Left"),
        sequenceDef("roll.grid_widen", Scope::EditorRouted, QT_TR_NOOP("Widen Grid"),
                    QKeySequence::UnknownKey, "Ctrl+2"),
        sequenceDef("roll.grid_narrow", Scope::EditorRouted, QT_TR_NOOP("Narrow Grid"),
                    QKeySequence::UnknownKey, "Ctrl+1"),
        sequenceDef("roll.grid_triplet", Scope::EditorRouted, QT_TR_NOOP("Toggle Triplet Grid"),
                    QKeySequence::UnknownKey, "Ctrl+3"),
