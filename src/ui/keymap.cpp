...
const Def kDefs[] = {
    ...
    {"roll.lengthen_note", Context::Timeline, QT_TR_NOOP("Piano Roll"), QT_TR_NOOP("Lengthen Note"),
     QKeySequence::UnknownKey, "Shift+Right"},
    {"roll.shorten_note", Context::Timeline, QT_TR_NOOP("Piano Roll"), QT_TR_NOOP("Shorten Note"),
