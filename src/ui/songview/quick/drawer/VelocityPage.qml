...
FocusScope {
    ...
    /// geometry read below goes through these guarded expressions instead of a
    /// call that would fail in that window.
    ...
    QtObject {
        ...
        readonly property string rampColor: "#302C29"
    ...
    Item {
        ...
        Rectangle {
            ...
            height: 1
            color: (page.pageModel ? page.pageModel.rampColor : "#302C29")
