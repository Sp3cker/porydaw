...
using Point = AutomationLaneEdit::Point;
...
AutomationLaneEdit::AutomationLaneEdit(Target target, std::vector<Point> originalPoints)
    : m_target(target)
...
AutomationLaneEdit::replacePointRange(uint64_t tickBegin, uint64_t tickEnd,
...
AutomationLaneEdit::Completion
AutomationLaneEdit::replaceHeldSpan(uint64_t tickBegin, uint64_t tickEnd, uint64_t songEndTick,
