    ...
    static const auto definitions = [] {
        ...
        return std::vector<CheckDefinition>{
            ...
            },
            {
                ...
                .handler =
                    [](QApplication &, const QStringList &args) {
                        return runSelectionKeyCoreCheck(args[1], args[2]);
                    },
                .scratchKind = ScratchKind::ExistingDirectory,
                .fixtureRootKind = FixtureRootKind::DecompProject,
                .fixtureFiles = route101RichFiles,
            ...
            },
            {
                ...
                .handler =
                    [](QApplication &, const QStringList &args) {
                        return runSelectionKeyGestureCheck(args[1], args[2]);
                    },
                .scratchKind = ScratchKind::ExistingDirectory,
                .fixtureRootKind = FixtureRootKind::DecompProject,
                .fixtureFiles = route101RichFiles,
            ...
            },
            {
                ...
                .handler =
                    [](QApplication &, const QStringList &args) {
                        return runSelectionKeyWindowCheck(args[1], args[2], args[3]);
                    },
                .scratchKind = ScratchKind::ExistingDirectory,
                .fixtureRootKind = FixtureRootKind::DecompProject,
                .fixtureFiles = twoSongRichFiles,
            ...
            },
            {
                ...
                .handler =
                    [](QApplication &, const QStringList &args) {
                        return runSelectionKeyLocalInputCheck(args[1], args[2]);
                    },
                .scratchKind = ScratchKind::ExistingDirectory,
                .fixtureRootKind = FixtureRootKind::DecompProject,
                .fixtureFiles = route101RichFiles,
