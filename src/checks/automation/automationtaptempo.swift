...
func drawerAutomationTapTempoCadenceAndCommit(_ report: CheckReport, suite: DocumentSession,
    ...
    report.expectEqual(expected: 0, actual: cadence.draftBpm, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: 6, actual: cadence.tapCount, cppID: drawerAutomationTapTempoID,
                       what: "six taps stand in the session")
    report.expectEqual(expected: 120, actual: cadence.draftBpm, cppID: drawerAutomationTapTempoID,
                       what: "a steady 500 ms cadence drafts 120 BPM")
    report.expectEqual(expected: 750, actual: cadence.idleCommitMs, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: 10, actual: cadence.tapCount, cppID: drawerAutomationTapTempoID,
                       what: "ten taps stand in the session")
    report.expectEqual(expected: 109, actual: cadence.draftBpm, cppID: drawerAutomationTapTempoID,
                       what: "the draft is the clipped mean of the newest eight intervals")
    report.expectEqual(expected: 826, actual: cadence.idleCommitMs, cppID: drawerAutomationTapTempoID,
    ...
    cadence.reset()
    report.expectEqual(expected: AutomationTapTempoSession(), actual: cadence, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: TimeDefaults.maximumTempoBPM, actual: burst.draftBpm, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: ["0:120"], actual: fixture.tempoValues, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: 120, actual: fixture.page.tapTempoSession.draftBpm, cppID: drawerAutomationTapTempoID,
                       what: "the tapped cadence named the tempo already in place")
    report.expectEqual(expected: 4, actual: fixture.page.tapTempoSession.tapCount, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: before.revision, actual: fixture.document.revision, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: 150, actual: fixture.page.tapTempoSession.draftBpm, cppID: drawerAutomationTapTempoID,
                       what: "a 400 ms cadence drafts 150 BPM")
    report.expect(fixture.page.tapTempoIdleElapsed(), cppID: drawerAutomationTapTempoID,
                  message: "the idle window commits the ready draft")
    report.expectEqual(expected: ["0:150"], actual: fixture.tempoValues, cppID: drawerAutomationTapTempoID,
                       what: "the commit replaced the tick-zero tempo point")
    report.expectEqual(expected: before.revision + 1, actual: fixture.document.revision, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: stale, actual: fixture.document.revision, cppID: drawerAutomationTapTempoID,
    ...
    report.expectEqual(expected: TimeDefaults.maximumTempoBPM, actual: fixture.page.tapTempoSession.draftBpm,
                       cppID: drawerAutomationTapTempoID,
                       what: "the page session clamps the 150 ms burst to the maximum tempo")
    report.expect(fixture.page.tapTempoIdleElapsed(), cppID: drawerAutomationTapTempoID,
                  message: "the idle window commits the clamped draft")
    report.expectEqual(expected: ["0:\(TimeDefaults.maximumTempoBPM)"], actual: fixture.tempoValues,
                       cppID: drawerAutomationTapTempoID,
...
func drawerAutomationTapTempoStrayAndEmptyStream(_ report: CheckReport, suite: DocumentSession,
    ...
    report.expectEqual(expected: TimeDefaults.maximumTempoBPM, actual:
                       AutomationTapTempoSession.bpm(forMeanIntervalMs: 150), cppID: id,
                       what: "a 150 ms mean clamps to the published maximum tempo")
    report.expectEqual(expected: TimeDefaults.minimumTempoBPM, actual:
    ...
    report.expectEqual(expected: strayBefore, actual: stray.snapshot, cppID: id,
    ...
    report.expect(later.page.tapTempoIdleElapsed(), cppID: id,
                  message: "the idle window commits the ready draft")
    report.expectEqual(expected: ["0:150", "384:140"], actual: later.tempoValues, cppID: id,
    ...
    report.expectEqual(expected: ["0:120", "384:140"], actual: later.tempoValues, cppID: id,
    ...
    report.expectEqual(expected: ["0:150"], actual: empty.tempoValues, cppID: id,
