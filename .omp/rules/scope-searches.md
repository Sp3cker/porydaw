...
- Pick the smallest owning folder: `src/core`, `src/project`, `src/audio`, `src/ui/editordrawer`, `src/ui/theme`, `src/ui/songview.cpp`, or `src/checks` (post-move: `src/*check.cpp`).
