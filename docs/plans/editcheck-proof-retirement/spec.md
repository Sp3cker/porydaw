...
| `documentGlobalMetadata` | A145-A158 | 14 STALE — pure reclassification win (globals survival asserted across `trackEditing`/`trackMove`/`trackDeleteRescue`/`adoptionAndPairing`) |
